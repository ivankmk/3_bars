...
def load_file():
    ...
    bars = json.loads(url.read().decode('utf-8'))
...
if __name__ == '__main__':
    ...
    print('Closest bar: {}'.format(get_closest_bar(data,
                                                      my_longitude,
                                                      my_latitude)))
    print('Smalles bar: {}'
          .format(get_smallest_bar(data)['properties']['Attributes']['Name']))
    print('Biggest bar: {}'
          .format(get_biggest_bar(data)['properties']['Attributes']['Name']))
